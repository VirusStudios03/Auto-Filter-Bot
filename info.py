...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '6052565020:AAGSj-s7O0FJUKe9zc6cWdnhmNJkavu15Is')
if len(BOT_TOKEN) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001800011644').split()]
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Virusbot:virus347000vmp03@cluster0.aexnusr.mongodb.net/?retryWrites=true&w=majority")
...
DELETE_TIME = int(environ.get('DELETE_TIME', 3600 300)) # Add time in seconds
